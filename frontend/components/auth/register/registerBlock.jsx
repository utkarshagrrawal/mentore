...
export function RegisterBlock({
  ...
  let passwordConditions = Object.keys(conditionsList).map((key, index) => {
    return (
      <li key={index} className="text-sm font-semibold text-red-500">
        {conditionsList[key]}
      </li>
    );
  });
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="mt-2 flex justify-between">
            ...
            <div>
              <input
                ...
                required
              />
              <label htmlFor="mentor" className="mr-4">
                Mentor
              </label>
              <input
                type="radio"
              ...
              <div>
                ...
                <div className="mt-2">
                  <Select
                    ...
                    options={allSkills.current.map((skill) => {
          ...
          <div
            className={`py-2 rounded-md ${
              register.password.length > 0 && conditionsList
                ? "block"
                : "hidden"
            }`}
          >
