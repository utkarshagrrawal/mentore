...
export function Question() {
  ...
  return (
    <>
      ...
      <div className="border border-gray-300 mx-16 mt-8 rounded-lg shadow-lg p-6">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-wrap mt-2">
            {question.length > 0 &&
              question[0].tags?.length > 0 &&
              question[0].tags.map((tag, index) => (
                <span
                  key={index}
                  className="px-3 py-1 bg-blue-500 text-white rounded-lg mr-2 mb-2 hover:bg-blue-700"
                >
                  {tag}
                </span>
              ))}
      ...
      <div
        className={`mx-16 mt-10 p-6 border rounded-lg shadow-md ${
          user.type === "mentor" || "hidden"
        }`}
      >
