...
export default function BookingRequest({
  ...
  const handleSchedule = async () => {
    if (
      schedulingDetails.startDateTime === "" ||
      schedulingDetails.duration === "" ||
      schedulingDetails.about === ""
    ) {
      ...
      <div className="bg-blue-50 rounded-lg shadow-lg p-6 mx-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex flex-col">
            ...
            <input
              id="startDateTime"
              name="startDateTime"
              value={schedulingDetails.startDateTime}
              type="datetime-local"
              onChange={handleSchedulingDetails}
          ...
          <div className="flex flex-col">
            ...
            <input
              id="duration"
              name="duration"
              value={parseInt(schedulingDetails.duration || 0)}
              type="number"
              min={0}
              onChange={handleSchedulingDetails}
        ...
        <div className="mt-4">
          ...
          <textarea
            id="about"
            name="about"
            value={schedulingDetails.about}
            onChange={handleSchedulingDetails}
            placeholder="Please specify the reason in brief for this session requirement"
            className="border rounded-lg w-full px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
          ></textarea>
        </div>
        <div className="flex justify-center mt-4">
          <button
            className="bg-blue-700 focus:ring-2 focus:ring-blue-500 text-white font-medium rounded-lg text-sm px-8 py-[0.4rem] w-full flex justify-center"
            disabled={scheduling}
