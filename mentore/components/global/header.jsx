            ...
            <header className="w-full min-[572px]:block hidden">
                <div>
                    <div className='flex flex-wrap items-center min-[573px]:justify-between min-[760px]:mx-8 min-[830px]:mx-16 mx-4 my-3'>
                        ...
                        <button onClick={handleLogin} className='text-white bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 focus:ring-4 focus:ring-blue-300 focus:outline-none font-medium rounded-lg text-sm px-8 py-3 shadow-md'>{props?.loggedIn ? 'Dashboard' : 'Login'}</button >
                    </div>
                </div>
                <hr className='w-full' />
            </header>
